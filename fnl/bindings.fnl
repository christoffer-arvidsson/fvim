...
(map! [n] :<leader>wh :<C-w>h "Select window left")
(map! [n] :<leader>wj :<C-w>j "Select window down")
(map! [n] :<leader>wk :<C-w>k "Select window up")
(map! [n] :<leader>wl :<C-w>l "Select window right")
